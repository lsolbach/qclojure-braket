...
(comment
  ...
  (spit "dev/devices/SV1.edn" (device-info backend "arn:aws:braket:::device/quantum-simulator/amazon/sv1"))
  (spit "dev/devices/DM1.edn" (device-info backend "arn:aws:braket:::device/quantum-simulator/amazon/dm1"))
  (spit "dev/devices/TN1.edn" (device-info backend "arn:aws:braket:::device/quantum-simulator/amazon/tn1"))
  (spit "dev/devices/Forte-1.edn" (device-info backend "arn:aws:braket:us-east-1::device/qpu/ionq/Forte-1"))
  (spit "dev/devices/Forte-Enterprise-1.edn" (device-info backend "arn:aws:braket:us-east-1::device/qpu/ionq/Forte-Enterprise-1"))
  (spit "dev/devices/Aria-1.edn" (device-info backend "arn:aws:braket:us-east-1::device/qpu/ionq/Aria-1"))
  (spit "dev/devices/Aria-2.edn" (device-info backend "arn:aws:braket:us-east-1::device/qpu/ionq/Aria-2"))
  (spit "dev/devices/Aquila.edn" (device-info backend "arn:aws:braket:us-east-1::device/qpu/quera/Aquila"))
  (spit "dev/devices/Borealis.edn" (device-info backend "arn:aws:braket:us-east-1::device/qpu/xanadu/Borealis"))
  (spit "dev/devices/Garnet.edn" (device-info backend "arn:aws:braket:eu-north-1::device/qpu/iqm/Garnet"))
  (spit "dev/devices/Emerald.edn" (device-info backend "arn:aws:braket:eu-north-1::device/qpu/iqm/Emerald"))
